...
Este repositorio es parte del camino troncal de Jeresoft Academy y se rige por
la RFC-0001, el manual fundacional del ecosistema.

## Objetivo

Crear el mejor recurso educativo posible sobre Cloud: modelos de servicio,
cómputo, almacenamiento, redes, identidad, servicios manejados, serverless,
costos, FinOps y práctica comparada en AWS y GCP.
...
- si un bloque busca contar para Pair Extraordinaire, la cuenta destinataria no
  ...
  `jeresoftx` usa `Joel Alvarez Mexia
